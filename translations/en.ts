...
export const enTranslations: Record<string, string> = {
  ...
  "auth.signInOverlay.title": "Sign in to continue",
  "auth.signInOverlay.subtitle": "Then use the Subscribe button above to activate your plan.",
  "auth.subscribe.button.subscribe": "Subscribe",
  "auth.subscribe.button.manage": "Manage / Unsubscribe",
  "auth.subscribe.button.checking": "Checking…",
  "auth.subscribe.button.redirecting": "Redirecting…",
  "auth.error.billingPortal": "Failed to open billing portal: {message}",
  "auth.error.checkout": "Failed to start checkout: {message}",
  "auth.signOut": "Sign out",
  "auth.signInWithGoogle": "Sign in with Google",
  "chat.error.cooldownActive": "You're in a cooldown due to insufficient tokens. Please wait a few minutes or purchase more tokens.",
  "chat.error.noTokens": "Not enough tokens to complete this request.",
  "header.tokensRemaining": "Tokens left (lifetime): ",
  "header.tokensPurchased": "Tokens purchased (lifetime): ",
  "header.tokensUsedBilled": "Tokens used (lifetime): ",
  "header.buyMoreTokens": "Press here for more tokens (press time based quantity)",
  "header.showDetailedTokenUsage": "Click to reveal details",
};
