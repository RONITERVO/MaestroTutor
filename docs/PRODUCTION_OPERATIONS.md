...
Gemini Live provider usage is recorded per completed model turn. Do not replace
that with a single maximum or final-session snapshot: retained context is billed
