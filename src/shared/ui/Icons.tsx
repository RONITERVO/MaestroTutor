...
export const IconFlag = (props: any) => <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.25 4.5v15m0-12c2.25 0 3.75-1.5 6-1.5s3.75 1.5 6 1.5 3.75-1.5 3.75-1.5v7.5s-1.5 1.5-3.75 1.5-3.75-1.5-6-1.5-3.75 1.5-6 1.5" /></svg>;
