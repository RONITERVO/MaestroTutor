...
export const IconSearch = ({ crossed = false, ...props }: any) => (
	<svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
		<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m15.75 15.75 4.5 4.5m-2.25-9a6.75 6.75 0 1 1-13.5 0 6.75 6.75 0 0 1 13.5 0Z" />
		{crossed && <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.75 3.75 20.25 20.25" />}
	</svg>
);
