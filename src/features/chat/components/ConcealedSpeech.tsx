...
export const ConcealedSpeech = ({ progress }: { progress: number }) => (
  <div role="status" aria-label="Speech received; preparing transcript" className="py-2" data-testid="concealed-speech">
