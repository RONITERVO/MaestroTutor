...
export const COLOR_GROUPS: ColorGroup[] = [
  {
    ...
    colors: [
      ...
      { cssVar: 'paper', friendlyName: 'Paper Surface', description: 'Save/confirm dialog checkmark and button text, and text on dark input-area overlays' },
  ...
  },
  {
    ...
    colors: [
      { cssVar: 'card', friendlyName: 'Card Background', description: 'Assistant message bubbles, translation input background, quick themes panel, undo/revert and send button backgrounds' },
      ...
      { cssVar: 'muted', friendlyName: 'Soft Surface', description: 'Color gradient picker background, selected-color highlight in the color panel, and other low-priority section backgrounds' },
      { cssVar: 'muted-foreground', friendlyName: 'Soft Text', description: 'Helper text, toolbar icons (global profile, avatar swap, terminal), and label text inside the API key gate' },
    ],
  },
  {
    ...
    colors: [
      { cssVar: 'primary', friendlyName: 'Primary Button', description: 'Text input area background, terminal button, entire traffic log panel, and main dark button backgrounds' },
      { cssVar: 'primary-foreground', friendlyName: 'Primary Button Text', description: 'Text inside the input area, navigation icons (globe, target, message, speaker), paperclip icon, and traffic log text' },
      { cssVar: 'secondary', friendlyName: 'Secondary Button', description: 'Language selector undo button, API key background in the key gate, and other secondary action button backgrounds' },
      { cssVar: 'secondary-foreground', friendlyName: 'Secondary Button Text', description: 'Text and icons on secondary buttons' },
      { cssVar: 'accent', friendlyName: 'Accent Button', description: 'Action buttons (Save Key, Open Google AI Studio), input area focus border, color-circle borders, API key icon and input border, privacy policy link text' },
      { cssVar: 'accent-foreground', friendlyName: 'Accent Button Text', description: 'Text on accent buttons — Save Key, Open Google AI Studio, Disable Image Generation' },
      { cssVar: 'destructive', friendlyName: 'Danger Button', description: 'Error message background and text, danger/delete action buttons and alerts' },
      { cssVar: 'destructive-foreground', friendlyName: 'Danger Button Text', description: 'Text on danger buttons and alerts' },
      { cssVar: 'eraser', friendlyName: 'Eraser Action', description: 'Delete individual message button (pink eraser-style)' },
    ],
  },
  {
    ...
    colors: [
      { cssVar: 'border', friendlyName: 'Default Border', description: 'Most borders and separator lines, color picker outline, maestro avatar reset border, quick themes border, traffic log header line' },
      ...
      { cssVar: 'pencil-light', friendlyName: 'Light Pencil Line', description: 'Sketchy outlines on suggestion chips, focused input fields, language undo button, assistant message bubbles, error buttons, API key inputs and icons, language flags, and send button' },
    ],
  },
  {
  ...
  },
  {
    ...
    colors: [
      { cssVar: 'status-listening-bg', friendlyName: 'Listening Background', description: 'Flag background while maestro is listening' },
      { cssVar: 'status-listening-border', friendlyName: 'Listening Border', description: 'Flag border while maestro is listening' },
      { cssVar: 'status-listening-text', friendlyName: 'Listening Text', description: 'Flag icon/text while maestro is listening' },
      { cssVar: 'status-observing-bg', friendlyName: 'Observing Background', description: 'Flag background while observing quietly' },
      { cssVar: 'status-observing-border', friendlyName: 'Observing Border', description: 'Flag border while observing quietly' },
      { cssVar: 'status-observing-text', friendlyName: 'Observing Text', description: 'Flag icon/text while observing quietly' },
  ...
  },
  {
    ...
    colors: [
      ...
      { cssVar: 'live-session-button-active-bg', friendlyName: 'Live Button Active Background', description: 'Live-session button background when session is active' },
      { cssVar: 'live-session-button-active-hover-bg', friendlyName: 'Live Button Active Hover', description: 'Live-session button hover color when session is active' },
      { cssVar: 'live-session-button-active-text', friendlyName: 'Live Button Active Text', description: 'Live-session button text when session is active' },
      { cssVar: 'live-session-button-error-bg', friendlyName: 'Top Live Button Error Background', description: 'Top live button background when retry is needed' },
      { cssVar: 'live-session-button-error-hover-bg', friendlyName: 'Top Live Button Error Hover', description: 'Top live button hover color when retry is needed' },
      { cssVar: 'live-session-button-error-text', friendlyName: 'Top Live Button Error Text', description: 'Top live button text when retry is needed' },
  ...
  },
  {
    ...
    collapsedByDefault: true,
    colors: [
      { cssVar: 'action-load', friendlyName: 'Load Panel', description: 'Panel background for load/import actions' },
      { cssVar: 'action-load-text', friendlyName: 'Load Panel Text', description: 'Text color in load/import panels' },
      { cssVar: 'action-danger', friendlyName: 'Delete Panel', description: 'Panel background for delete/reset actions' },
      { cssVar: 'action-danger-text', friendlyName: 'Delete Panel Text', description: 'Text color in delete/reset panels' },
      { cssVar: 'action-export', friendlyName: 'Export Panel', description: 'Panel background for export actions' },
      { cssVar: 'action-export-text', friendlyName: 'Export Panel Text', description: 'Text color in export panels' },
      { cssVar: 'action-combine', friendlyName: 'Combine Panel', description: 'Panel background for merge/combine actions' },
      { cssVar: 'action-combine-text', friendlyName: 'Combine Panel Text', description: 'Text color in merge/combine panels' },
      { cssVar: 'action-trim', friendlyName: 'Trim Panel', description: 'Panel background for trim actions' },
  ...
  },
  {
    ...
    collapsedByDefault: true,
    colors: [
      { cssVar: 'pencil', friendlyName: 'Pencil', description: 'Input area inner and outer sketch outlines, API key gate sketch lines, API key gate heading, API key text and usage cost display' },
      ...
      { cssVar: 'watercolor', friendlyName: 'Watercolor Wash', description: 'Global profile editing section, URL links in chat, native language selection highlight, and soft watercolor accent wash' },
