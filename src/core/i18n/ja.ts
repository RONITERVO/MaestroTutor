...
export const jaTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testerFormTitle": "アプリをテストする",
  "apiKeyGate.testAppLink": " 送信して確認メールを受け取りましたか？ここからアプリを取得してください：https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "Androidベータ版の招待状を受け取るために、Google Playストアで使用しているメールアドレスを入力してください！",
  "apiKeyGate.testerFormSubmit": "早期アクセスを取得",
  "apiKeyGate.testerFormSubmitting": "送信中...",
  "apiKeyGate.testerFormSuccessTitle": "ありがとうございます！",
  "apiKeyGate.testerFormSuccessDesc": "人間があなたのメールアドレスを確認しています。これには時間がかかります。リンクは {TheUserEmail} で即座には機能しません。",
  "apiKeyGate.testerFormNextSteps": "確認が完了すると（最大1日）、このリンクをメールでお送りします（今は一時的にこのページを離れても構いません）： ",
  "apiKeyGate.testerFormError": "何らかのエラーが発生しました。もう一度お試しください。",
  "apiKeyGate.testerFormMustBeGmail": "Google Playには @gmail.com のアドレスを使用してください。",
