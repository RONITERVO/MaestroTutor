...
export const ruTranslations: Record<string, string> = {
  ...
  "error.apiKeyInvalid": "Ваш ключ API Gemini недействителен. Проверьте на наличие опечаток и вставьте действующий ключ.",
  "error.apiQuotaExceeded": "Ваша бесплатная квота Gemini API для чата исчерпана. Я открыл экран ключа API с инструкциями по биллингу. В то же время вы все еще можете использовать живое общение.",
