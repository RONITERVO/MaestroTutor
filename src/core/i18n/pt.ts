...
export const ptTranslations: Record<string, string> = {
  ...
  "chat.liveSession.activeIndicator": "A sessão de vídeo ao vivo está ativa, o Maestro pode vê-lo e ouvi-lo.",
  ...
  "audio.progress": "Progresso do áudio",
  "camera.observerActive": "Observador ativo",
  "chat.bookmark.cancel": "Cancelar",
  "chat.bookmark.editAria": "Editar resumo do marcador",
  "chat.bookmark.hiddenBelow": "As mensagens estão ocultas abaixo",
  "chat.bookmark.hiddenCount": "{count} mensagens acima ocultas",
  "chat.bookmark.returnToRecent": "Voltar para as mensagens abaixo",
  "chat.bookmark.save": "Salvar",
  "chat.bookmark.showAboveChunk": "Mostrar mensagens acima",
  "chat.bookmark.showNextChunk": "Mostrar {count} acima",
  "chat.bookmark.showPreviousChunk": "Mostrar {count} abaixo",
  "chat.bookmark.showingAboveRange": "Mostrando mensagens acima {start}-{end} de {total}",
  "chat.bookmark.summaryPlaceholder": "Resumo...",
  "chat.camera.capturePhoto": "Tirar foto",
  "chat.camera.startRecording": "Iniciar gravação de vídeo",
  "chat.deleteMessage": "Excluir mensagem",
  "chat.drawMessage": "Desenhar mensagem",
  "chat.focusedMode.enter": "Entrar no modo focado",
  "chat.focusedMode.exit": "Sair do modo focado",
  "chat.music.finalizing": "Salvando música...",
  "chat.music.starting": "Iniciando música...",
  "chat.music.streaming": "Transmitindo música...",
  "chat.pdf.loadFailed": "Falha ao carregar o PDF",
  "debugLog.clearLogs": "Limpar logs",
  "debugLog.clearUploads": "Excluir todos os uploads do Gemini para a chave API atual",
  "debugLog.close": "Fechar",
  "debugLog.error": "Erro",
  "debugLog.noTraffic": "Nenhum tráfego registrado ainda.",
  "debugLog.requestPayload": "Payload da requisição",
  "debugLog.response": "Resposta",
  "debugLog.title": "Log de tráfego",
  "error.cameraOverconstrained": "Câmera não disponível com as configurações solicitadas. {errorMessage}",
  "globalProfile.ariaLabel": "Resumo do perfil global",
  "globalProfile.loading": "Carregando perfil...",
  "globalProfile.noProfile": "Nenhum perfil ainda.",
  "header.apiKey": "Chave API",
  "header.apiKeyRequired": "Chave API necessária",
  "header.clickToViewStatus": "Clique para ver o status",
  "header.manageApiKey": "Gerenciar chave API",
  "header.pauseMaestro": "Pausar Maestro",
  "header.resumeMaestro": "Retomar Maestro",
  "header.viewTrafficLogs": "Ver logs de tráfego",
  "miniGame.codeEmpty": "O código do mini-jogo está vazio.",
  "miniGame.failedToRender": "O mini-jogo falhou ao renderizar.",
  "miniGame.fullscreen": "Tela cheia",
  "miniGame.hideCode": "Ocultar código",
  "miniGame.launching": "Iniciando mini-jogo...",
  "miniGame.restart": "Reiniciar",
  "miniGame.retry": "Tentar novamente",
  "miniGame.runtimeError": "Erro no mini-jogo: {error}",
  "miniGame.showCode": "Mostrar código",
  "miniGame.title": "Mini jogo",
  "miniGame.titleWithFile": "Mini jogo {fileName}",
  "officeFile.failedToParse": "Falha ao analisar a prévia inline.",
  "officeFile.localPreviewUnavailable": "Prévia local indisponível. Reanexe para abrir localmente.",
  "officeFile.openFile": "Abrir arquivo",
  "officeFile.openInGoogleWorkspace": "Abrir no Google Workspace",
  "officeFile.parsingInlinePreview": "Analisando prévia inline...",
  "officeFile.parsingPreview": "Analisando prévia...",
  "officeFile.previewUnavailable": "Prévia não disponível para este arquivo.",
  "officeFile.rawExtractedText": "Texto extraído bruto",
  "sessionControls.customizeColors": "Personalizar cores",
  "streaming.connectingTo": "Conectando a {model} (tentativa {attempt}/{total})...",
  "streaming.failedToPrepareAttachment": "Falha ao preparar o anexo recente \"{name}\" para envio. Tente novamente ou reanexe o arquivo.",
  "streaming.failedToPrepareCurrent": "Falha ao preparar a mídia anexada \"{name}\" para o Gemini. Tente novamente ou reanexe o arquivo.",
  "streaming.highDemand": "Alta demanda detectada. A requisição está na fila nos servidores do Google.",
  "streaming.noOutputAfter": "Sem saída do modelo após {seconds}s. A requisição provavelmente está na fila nos servidores do Google.",
  "streaming.phaseConnecting": "Conectando",
  "streaming.phaseFinalResponse": "Resposta final",
  "streaming.phaseFinalizing": "Finalizando",
  "streaming.phaseHighDemand": "Alta demanda",
  "streaming.phasePreparingRequest": "Preparando requisição",
  "streaming.phaseProcessing": "Processando",
  "streaming.phaseRetrying": "Tentando novamente",
  "streaming.phaseSwitchingModel": "Trocando modelo",
  "streaming.phaseThinking": "Pensando",
  "streaming.preparingRequestContext": "Preparando contexto da requisição...",
  "streaming.retryingIn": "Tentando novamente em {seconds}s...",
  "streaming.switchingFallback": "Alternando para o modelo de fallback {model}.",
  "streaming.waitingForOutput": "Aguardando saída do modelo... {seconds}s decorridos.",
  "textFile.rawText": "Texto bruto",
  "textFile.unableToDecode": "Não foi possível decodificar o anexo de texto.",
  "themeCustomizer.cancel": "Cancelar",
  "themeCustomizer.confirm": "Confirmar",
  "themeCustomizer.deletePreset": "Excluir preset salvo",
  "themeCustomizer.exportAs": "Exportar como",
  "themeCustomizer.exportToFile": "Exportar para arquivo",
  "themeCustomizer.importFromFile": "Importar de arquivo",
  "themeCustomizer.instruction": "Toque em um círculo de cor e arraste no seletor. As alterações são aplicadas na hora.",
  "themeCustomizer.namePlaceholder": "Nome do tema...",
  "themeCustomizer.quickThemes": "Temas rápidos",
  "themeCustomizer.resetAll": "Redefinir tudo",
  "themeCustomizer.saveAs": "Salvar como",
  "themeCustomizer.saveAsPreset": "Salvar como preset",
  "themeCustomizer.storeDescription": "Explore e compre mais temas",
  "themeCustomizer.storeTitle": "Loja de temas",
  "themeCustomizer.title": "Paleta de cores",
  "themeStore.buy": "Comprar",
  "themeStore.close": "Fechar",
  "themeStore.footerNote": "As compras são gerenciadas pelo Google Play e vinculadas à sua conta do Google. Toque no botão de restaurar (↩) para recuperar compras anteriores ao reinstalar.",
  "themeStore.loading": "Carregando temas…",
  "themeStore.notAvailable": "As compras de temas estão disponíveis apenas no Android pelo Google Play.",
  "themeStore.owned": "Adquirido",
  "themeStore.purchaseFailed": "Falha na compra. Verifique sua conexão e tente novamente.",
  "themeStore.restorePurchases": "Restaurar compras",
  "themeStore.title": "Loja de temas",
};