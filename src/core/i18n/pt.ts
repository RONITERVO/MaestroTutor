...
export const ptTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testerFormTitle": "Testar o aplicativo",
  "apiKeyGate.testAppLink": " Você enviou e recebeu a confirmação por e-mail? Obtenha o aplicativo aqui: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "Insira o e-mail que você usa para a Google Play Store para receber um convite para a nossa versão beta do Android!",
  "apiKeyGate.testerFormSubmit": "Obter acesso antecipado",
  "apiKeyGate.testerFormSubmitting": "Enviando...",
  "apiKeyGate.testerFormSuccessTitle": "Obrigado!",
  "apiKeyGate.testerFormSuccessDesc": "Humanos estão confirmando seu e-mail. Isso levará algum tempo. O link não funcionará para {TheUserEmail} instantaneamente.",
  "apiKeyGate.testerFormNextSteps": "Quando a confirmação for concluída (até 1 dia), enviaremos este link por e-mail (você pode sair desta página por enquanto): ",
  "apiKeyGate.testerFormError": "Algo deu errado. Por favor, tente novamente.",
  "apiKeyGate.testerFormMustBeGmail": "Por favor, use um endereço @gmail.com para o Google Play.",
  "apiKeyGate.testerFormCapReached": "Limite de envios atingido. Obrigado!",
  "apiKeyGate.developerLogin": "login de desenvolvedor",
  "apiKeyGate.submitAnotherEmail": "Digitou o e-mail errado? Envie outro.",
  "apiKeyGate.testerFormDuplicateEmail": "Este e-mail já foi enviado.",
  // Chat - general
