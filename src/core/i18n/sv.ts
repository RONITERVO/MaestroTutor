...
export const svTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testAppLink": " Har du skickat in och fått e-postbekräftelsen? Hämta appen här: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "Ange den e-postadress du använder för Google Play Butik för att få en inbjudan till vår Android-beta!",
  "apiKeyGate.testerFormSubmit": "Få tidig åtkomst",
  "apiKeyGate.testerFormSubmitting": "Skickar...",
  "apiKeyGate.testerFormSuccessTitle": "Tack!",
  "apiKeyGate.testerFormSuccessDesc": "Människor bekräftar din e-postadress. Detta kommer att ta tid. Länken fungerar inte för {TheUserEmail} direkt.",
  "apiKeyGate.testerFormNextSteps": "När bekräftelsen är klar (upp till 1 dag) mejlar vi den här länken till dig (du kan lämna den här sidan för tillfället): ",
