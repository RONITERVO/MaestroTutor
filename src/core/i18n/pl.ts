...
export const plTranslations: Record<string, string> = {
  ...
  "chat.liveSession.activeIndicator": "Sesja wideo na żywo jest aktywna, Maestro może Cię widzieć i słyszeć.",
  ...
  "audio.pause": "Pauza",
  "audio.play": "Odtwórz",
  "audio.progress": "Postęp dźwięku",
  "camera.observerActive": "Obserwator aktywny",
  "chat.bookmark.cancel": "Anuluj",
  "chat.bookmark.editAria": "Edytuj podsumowanie zakładki",
  "chat.bookmark.hiddenBelow": "Wiadomości są ukryte poniżej",
  "chat.bookmark.hiddenCount": "{count} wiadomości powyżej ukrytych",
  "chat.bookmark.returnToRecent": "Wróć do wiadomości poniżej",
  "chat.bookmark.save": "Zapisz",
  "chat.bookmark.showAboveChunk": "Pokaż wiadomości powyżej",
  "chat.bookmark.showNextChunk": "Pokaż {count} powyżej",
  "chat.bookmark.showPreviousChunk": "Pokaż {count} poniżej",
  "chat.bookmark.showingAboveRange": "Wyświetlanie wiadomości powyżej {start}-{end} z {total}",
  "chat.bookmark.summaryPlaceholder": "Podsumowanie...",
  "chat.camera.capturePhoto": "Zrób zdjęcie",
  "chat.camera.startRecording": "Rozpocznij nagrywanie wideo",
  "chat.deleteMessage": "Usuń wiadomość",
  "chat.drawMessage": "Narysuj wiadomość",
  "chat.focusedMode.enter": "Włącz tryb skupienia",
  "chat.focusedMode.exit": "Wyłącz tryb skupienia",
  "chat.music.finalizing": "Zapisywanie muzyki...",
  "chat.music.starting": "Uruchamianie muzyki...",
  "chat.music.streaming": "Strumieniowanie muzyki...",
  "chat.pdf.loadFailed": "Nie udało się wczytać PDF",
  "debugLog.clearLogs": "Wyczyść logi",
  "debugLog.clearUploads": "Usuń wszystkie przesłane pliki Gemini dla bieżącego klucza API",
  "debugLog.close": "Zamknij",
  "debugLog.error": "Błąd",
  "debugLog.noTraffic": "Nie zarejestrowano jeszcze żadnego ruchu.",
  "debugLog.requestPayload": "Treść żądania",
  "debugLog.response": "Odpowiedź",
  "debugLog.title": "Dziennik ruchu",
  "error.cameraOverconstrained": "Kamera niedostępna z żądanymi ustawieniami. {errorMessage}",
  "globalProfile.ariaLabel": "Podsumowanie profilu globalnego",
  "globalProfile.loading": "Ładowanie profilu...",
  "globalProfile.noProfile": "Brak profilu.",
  "header.apiKey": "Klucz API",
  "header.apiKeyRequired": "Wymagany klucz API",
  "header.clickToViewStatus": "Kliknij, aby zobaczyć status",
  "header.manageApiKey": "Zarządzaj kluczem API",
  "header.pauseMaestro": "Wstrzymaj Maestro",
  "header.resumeMaestro": "Wznów Maestro",
  "header.viewTrafficLogs": "Wyświetl dzienniki ruchu",
  "miniGame.codeEmpty": "Kod minigry jest pusty.",
  "miniGame.failedToRender": "Nie udało się wyrenderować minigry.",
  "miniGame.fullscreen": "Pełny ekran",
  "miniGame.hideCode": "Ukryj kod",
  "miniGame.launching": "Uruchamianie minigry...",
  "miniGame.restart": "Uruchom ponownie",
  "miniGame.retry": "Spróbuj ponownie",
  "miniGame.runtimeError": "Błąd minigry: {error}",
  "miniGame.showCode": "Pokaż kod",
  "miniGame.title": "Minigra",
  "miniGame.titleWithFile": "Minigra {fileName}",
  "officeFile.failedToParse": "Nie udało się przetworzyć wbudowanego podglądu.",
  "officeFile.localPreviewUnavailable": "Lokalny podgląd niedostępny. Dołącz ponownie, aby otworzyć lokalnie.",
  "officeFile.openFile": "Otwórz plik",
  "officeFile.openInGoogleWorkspace": "Otwórz w Google Workspace",
  "officeFile.parsingInlinePreview": "Przetwarzanie wbudowanego podglądu...",
  "officeFile.parsingPreview": "Przetwarzanie podglądu...",
  "officeFile.previewUnavailable": "Podgląd niedostępny dla tego pliku.",
  "officeFile.rawExtractedText": "Nieprzetworzony wyodrębniony tekst",
  "sessionControls.customizeColors": "Dostosuj kolory",
  "streaming.connectingTo": "Łączenie z {model} (próba {attempt}/{total})...",
  "streaming.failedToPrepareAttachment": "Nie udało się przygotować załącznika \"{name}\" do wysłania. Spróbuj ponownie lub ponownie dołącz plik.",
  "streaming.failedToPrepareCurrent": "Nie udało się przygotować dołączonego pliku multimedialnego \"{name}\" dla Gemini. Spróbuj ponownie lub ponownie dołącz plik.",
  "streaming.highDemand": "Wykryto duże obciążenie. Żądanie jest w kolejce na serwerach Google.",
  "streaming.noOutputAfter": "Brak wyników modelu po {seconds}s. Żądanie prawdopodobnie czeka w kolejce na serwerach Google.",
  "streaming.phaseConnecting": "Łączenie",
  "streaming.phaseFinalResponse": "Ostateczna odpowiedź",
  "streaming.phaseFinalizing": "Finalizowanie",
  "streaming.phaseHighDemand": "Duże obciążenie",
  "streaming.phasePreparingRequest": "Przygotowywanie żądania",
  "streaming.phaseProcessing": "Przetwarzanie",
  "streaming.phaseRetrying": "Ponowna próba",
  "streaming.phaseSwitchingModel": "Przełączanie modelu",
  "streaming.phaseThinking": "Myślenie",
  "streaming.preparingRequestContext": "Przygotowywanie kontekstu żądania...",
  "streaming.retryingIn": "Ponowna próba za {seconds}s...",
  "streaming.switchingFallback": "Przełączanie na model zapasowy {model}.",
  "streaming.waitingForOutput": "Oczekiwanie na wyniki modelu... minęło {seconds}s.",
  "textFile.rawText": "Nieprzetworzony tekst",
  "textFile.unableToDecode": "Nie można zdekodować załącznika tekstowego.",
  "themeCustomizer.cancel": "Anuluj",
  "themeCustomizer.confirm": "Potwierdź",
  "themeCustomizer.deletePreset": "Usuń zapisany preset",
  "themeCustomizer.exportAs": "Eksportuj jako",
  "themeCustomizer.exportToFile": "Eksportuj do pliku",
  "themeCustomizer.importFromFile": "Importuj z pliku",
  "themeCustomizer.instruction": "Dotknij koła koloru, a następnie przeciągnij w selektorze. Zmiany są stosowane natychmiast.",
  "themeCustomizer.namePlaceholder": "Nazwa motywu...",
  "themeCustomizer.quickThemes": "Szybkie motywy",
  "themeCustomizer.resetAll": "Zresetuj wszystko",
  "themeCustomizer.saveAs": "Zapisz jako",
  "themeCustomizer.saveAsPreset": "Zapisz jako preset",
  "themeCustomizer.storeDescription": "Przeglądaj i kupuj więcej motywów",
  "themeCustomizer.storeTitle": "Sklep z motywami",
  "themeCustomizer.title": "Malowanie kolorów",
  "themeStore.buy": "Kup",
  "themeStore.close": "Zamknij",
  "themeStore.footerNote": "Zakupy są zarządzane przez Google Play i powiązane z Twoim kontem Google. Naciśnij przycisk przywracania (↩), aby odzyskać poprzednie zakupy po ponownej instalacji.",
  "themeStore.loading": "Ładowanie motywów…",
  "themeStore.notAvailable": "Zakupy motywów są dostępne tylko na Androidzie przez Google Play.",
  "themeStore.owned": "Zakupiono",
  "themeStore.purchaseFailed": "Zakup nie powiódł się. Sprawdź połączenie i spróbuj ponownie.",
  "themeStore.restorePurchases": "Przywróć zakupy",
  "themeStore.title": "Sklep z motywami",
};