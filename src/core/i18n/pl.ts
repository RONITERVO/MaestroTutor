...
export const plTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testAppLink": " Wysłano i otrzymano potwierdzenie e-mail? Pobierz aplikację tutaj: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "Wprowadź e-mail, którego używasz w Google Play Store, aby otrzymać zaproszenie do naszej bety na Androida!",
  "apiKeyGate.testerFormSubmit": "Uzyskaj wczesny dostęp",
  "apiKeyGate.testerFormSubmitting": "Wysyłanie...",
  "apiKeyGate.testerFormSuccessTitle": "Dziękujemy!",
  "apiKeyGate.testerFormSuccessDesc": "Ludzie weryfikują Twój adres e-mail. To trochę potrwa. Link nie zadziała dla {TheUserEmail} natychmiast.",
  "apiKeyGate.testerFormNextSteps": "Po zakończeniu weryfikacji (do 1 dnia) prześlemy Ci ten link e-mailem (możesz na razie opuścić tę stronę): ",
