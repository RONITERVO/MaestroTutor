...
export const thTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testAppLink": " ส่งและรับอีเมลยืนยันแล้วใช่ไหม? รับแอปที่นี่: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "ใส่อีเมลที่คุณใช้สำหรับ Google Play Store เพื่อรับคำเชิญเข้าร่วมการทดสอบ Android เบต้าของเรา!",
  "apiKeyGate.testerFormSubmit": "รับสิทธิ์เข้าถึงล่วงหน้า",
  "apiKeyGate.testerFormSubmitting": "กำลังส่ง...",
  "apiKeyGate.testerFormSuccessTitle": "ขอบคุณ!",
  "apiKeyGate.testerFormSuccessDesc": "ทีมงานกำลังยืนยันอีเมลของคุณ ขั้นตอนนี้อาจใช้เวลา ลิงก์จะไม่สามารถใช้งานกับ {TheUserEmail} ได้ในทันที",
  "apiKeyGate.testerFormNextSteps": "เมื่อยืนยันเสร็จสิ้น (ไม่เกิน 1 วัน) เราจะส่งลิงก์นี้ไปให้ทางอีเมล (คุณสามารถออกจากหน้านี้ได้ในตอนนี้): ",
  "apiKeyGate.testerFormError": "เกิดข้อผิดพลาดบางอย่าง โปรดลองอีกครั้ง",
