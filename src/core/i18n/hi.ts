...
export const hiTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testAppLink": " क्या आपने सबमिट कर दिया है और ईमेल पुष्टि प्राप्त कर ली है? ऐप यहाँ प्राप्त करें: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "हमारे Android बीटा का आमंत्रण प्राप्त करने के लिए वह ईमेल दर्ज करें जिसका उपयोग आप Google Play Store के लिए करते हैं!",
  "apiKeyGate.testerFormSubmit": "प्रारंभिक पहुँच प्राप्त करें",
  "apiKeyGate.testerFormSubmitting": "भेजा जा रहा है...",
  "apiKeyGate.testerFormSuccessTitle": "धन्यवाद!",
  "apiKeyGate.testerFormSuccessDesc": "मनुष्य आपके ईमेल की पुष्टि कर रहे हैं। इसमें समय लगेगा। लिंक {TheUserEmail} के लिए तुरंत काम नहीं करेगा।",
  "apiKeyGate.testerFormNextSteps": "जब पुष्टि हो जाएगी (1 दिन तक) तो हम आपको यह लिंक ईमेल करेंगे (आप अभी के लिए यह पृष्ठ छोड़ सकते हैं): ",
  "apiKeyGate.testerFormError": "कुछ गलत हो गया। कृपया पुन: प्रयास करें।",
  "apiKeyGate.testerFormMustBeGmail": "कृपया Google Play के लिए @gmail.com पते का उपयोग करें।",
  "apiKeyGate.testerFormCapReached": "सबमिशन सीमा पूरी हो गई। धन्यवाद!",
  "apiKeyGate.developerLogin": "डेवलपर लॉगिन",
  "apiKeyGate.submitAnotherEmail": "गलत ईमेल दर्ज किया? दूसरा सबमिट करें।",
