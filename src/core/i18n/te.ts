...
export const teTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testerFormTitle": "యాప్‌ను పరీక్షించండి",
  "apiKeyGate.testAppLink": " సమర్పించారా మరియు ఇమెయిల్ నిర్ధారణను పొందారా? యాప్‌ను ఇక్కడ పొందండి: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "మా Android బీటాకి ఆహ్వానం పొందడానికి మీరు Google Play Store కోసం ఉపయోగించే ఇమెయిల్‌ను నమోదు చేయండి!",
  "apiKeyGate.testerFormSubmit": "ముందస్తు యాక్సెస్ పొందండి",
  "apiKeyGate.testerFormSubmitting": "పంపబడుతోంది...",
  "apiKeyGate.testerFormSuccessTitle": "ధన్యవాదాలు!",
  "apiKeyGate.testerFormSuccessDesc": "మనుషులు మీ ఇమెయిల్‌ను నిర్ధారిస్తున్నారు. దీనికి సమయం పడుతుంది. లింక్ {TheUserEmail}కి తక్షణమే పని చేయదు.",
  "apiKeyGate.testerFormNextSteps": "నిర్ధారణ పూర్తయిన తర్వాత (1 రోజు వరకు) మేము మీకు ఈ లింక్‌ను ఇమెయిల్ చేస్తాము (మీరు ప్రస్తుతానికి ఈ పేజీ నుండి నిష్క్రమించవచ్చు): ",
  "apiKeyGate.testerFormError": "ఏదో తప్పు జరిగింది. దయచేసి మళ్లీ ప్రయత్నించండి.",
  "apiKeyGate.testerFormMustBeGmail": "దయచేసి Google Play కోసం @gmail.com చిరునామాను ఉపయోగించండి.",
