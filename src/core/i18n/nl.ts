...
export const nlTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testAppLink": " Heb je het formulier ingediend en de bevestiging per e-mail ontvangen? Download de app hier: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "Voer het e-mailadres in dat je voor de Google Play Store gebruikt om een uitnodiging voor onze Android-bèta te krijgen!",
  "apiKeyGate.testerFormSubmit": "Krijg vroege toegang",
  "apiKeyGate.testerFormSubmitting": "Verzenden...",
  "apiKeyGate.testerFormSuccessTitle": "Bedankt!",
  "apiKeyGate.testerFormSuccessDesc": "Mensen bevestigen nu je e-mail. Dit kost tijd. De link werkt niet direct voor {TheUserEmail}.",
  "apiKeyGate.testerFormNextSteps": "Wanneer de bevestiging is voltooid (maximaal 1 dag) mailen we je deze link (je kunt deze pagina nu verlaten): ",
