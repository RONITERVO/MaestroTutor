...
export const frTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testAppLink": " Vous avez soumis et reçu l'e-mail de confirmation ? Obtenez l'application ici : https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "Saisissez l'e-mail que vous utilisez pour le Google Play Store pour recevoir une invitation à notre version bêta Android !",
  "apiKeyGate.testerFormSubmit": "Obtenir un accès anticipé",
  "apiKeyGate.testerFormSubmitting": "Envoi...",
  "apiKeyGate.testerFormSuccessTitle": "Merci !",
  "apiKeyGate.testerFormSuccessDesc": "Des humains vérifient votre e-mail. Cela prendra du temps. Le lien ne fonctionnera pas instantanément pour {TheUserEmail}.",
  "apiKeyGate.testerFormNextSteps": "Une fois la confirmation terminée (jusqu'à 1 jour), nous vous enverrons ce lien par e-mail (vous pouvez quitter cette page pour le moment) : ",
  ...
  "apiKeyGate.testerFormCapReached": "Limite de soumissions atteinte. Merci !",
  "apiKeyGate.developerLogin": "connexion développeur",
  "apiKeyGate.submitAnotherEmail": "Vous avez saisi le mauvais e-mail ? Soumettez-en un autre.",
  "apiKeyGate.testerFormDuplicateEmail": "Cet e-mail a déjà été soumis.",
  // Chat - general
