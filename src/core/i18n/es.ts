...
export const esTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testerFormTitle": "Probar la aplicación",
  "apiKeyGate.testAppLink": " ¿Lo has enviado y recibido la confirmación por correo? Consigue la aplicación aquí: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "¡Introduce el correo que usas para Google Play Store para recibir una invitación a nuestra versión beta para Android!",
  "apiKeyGate.testerFormSubmit": "Obtener acceso anticipado",
  "apiKeyGate.testerFormSubmitting": "Enviando...",
  "apiKeyGate.testerFormSuccessTitle": "¡Gracias!",
  "apiKeyGate.testerFormSuccessDesc": "Humanos están confirmando tu correo electrónico. Esto tomará tiempo. El enlace no funcionará para {TheUserEmail} al instante.",
  "apiKeyGate.testerFormNextSteps": "Cuando se haya completado la confirmación (hasta 1 día), te enviaremos este enlace por correo (puedes salir de esta página por ahora): ",
  ...
  "apiKeyGate.testerFormCapReached": "Se ha alcanzado el límite de envíos. ¡Gracias!",
  "apiKeyGate.developerLogin": "acceso para desarrolladores",
  "apiKeyGate.submitAnotherEmail": "¿Ingresaste el correo equivocado? Envía otro.",
  "apiKeyGate.testerFormDuplicateEmail": "Este correo electrónico ya ha sido enviado.",
  // Chat - general
