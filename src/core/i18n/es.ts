...
export const esTranslations: Record<string, string> = {
  ...
  "camera.observerActive": "Observador activo",
  "chat.bookmark.cancel": "Cancelar",
  "chat.bookmark.editAria": "Editar resumen del marcador",
  "chat.bookmark.hiddenBelow": "Los mensajes están ocultos abajo",
  "chat.bookmark.hiddenCount": "{count} mensajes arriba ocultos",
  "chat.bookmark.returnToRecent": "Volver a los mensajes de abajo",
  "chat.bookmark.save": "Guardar",
  "chat.bookmark.showAboveChunk": "Mostrar mensajes de arriba",
  "chat.bookmark.showNextChunk": "Mostrar {count} arriba",
  "chat.bookmark.showPreviousChunk": "Mostrar {count} abajo",
  "chat.bookmark.showingAboveRange": "Mostrando mensajes arriba {start}-{end} de {total}",
  "chat.bookmark.summaryPlaceholder": "Resumen...",
  "chat.camera.capturePhoto": "Tomar foto",
  "chat.camera.startRecording": "Iniciar grabación de video",
  "chat.deleteMessage": "Eliminar mensaje",
  "chat.drawMessage": "Dibujar mensaje",
  "chat.focusedMode.enter": "Entrar en modo enfocado",
  "chat.focusedMode.exit": "Salir del modo enfocado",
  "chat.music.finalizing": "Guardando música...",
  "chat.music.starting": "Iniciando música...",
  "chat.music.streaming": "Transmitiendo música...",
  "chat.pdf.loadFailed": "Error al cargar el PDF",
  "debugLog.clearLogs": "Borrar registros",
  "debugLog.clearUploads": "Eliminar todas las subidas de Gemini para la clave API actual",
  "debugLog.close": "Cerrar",
  "debugLog.error": "Error",
  "debugLog.noTraffic": "Aún no hay tráfico registrado.",
  "debugLog.requestPayload": "Carga de la solicitud",
  "debugLog.response": "Respuesta",
  "debugLog.title": "Registro de tráfico",
  "error.cameraOverconstrained": "Cámara no disponible con la configuración solicitada. {errorMessage}",
  "globalProfile.ariaLabel": "Resumen del perfil global",
  "globalProfile.loading": "Cargando perfil...",
  "globalProfile.noProfile": "Aún no hay perfil.",
  "header.apiKey": "Clave API",
  "header.apiKeyRequired": "Clave API requerida",
  "header.clickToViewStatus": "Haz clic para ver el estado",
  "header.manageApiKey": "Gestionar clave API",
  "header.pauseMaestro": "Pausar Maestro",
  "header.resumeMaestro": "Reanudar Maestro",
  "header.viewTrafficLogs": "Ver registros de tráfico",
  "miniGame.codeEmpty": "El código del mini-juego está vacío.",
  "miniGame.failedToRender": "El mini-juego no se pudo renderizar.",
  "miniGame.fullscreen": "Pantalla completa",
  "miniGame.hideCode": "Ocultar código",
  "miniGame.launching": "Iniciando mini-juego...",
  "miniGame.restart": "Reiniciar",
  "miniGame.retry": "Reintentar",
  "miniGame.runtimeError": "Error en el mini-juego: {error}",
  "miniGame.showCode": "Mostrar código",
  "miniGame.title": "Mini juego",
  "miniGame.titleWithFile": "Mini juego {fileName}",
  "officeFile.failedToParse": "Error al analizar la vista previa en línea.",
  "officeFile.localPreviewUnavailable": "Vista previa local no disponible. Vuelve a adjuntar para abrir localmente.",
  "officeFile.openFile": "Abrir archivo",
  "officeFile.openInGoogleWorkspace": "Abrir en Google Workspace",
  "officeFile.parsingInlinePreview": "Analizando vista previa en línea...",
  "officeFile.parsingPreview": "Analizando vista previa...",
  "officeFile.previewUnavailable": "Vista previa no disponible para este archivo.",
  "officeFile.rawExtractedText": "Texto extraído sin formato",
  "sessionControls.customizeColors": "Personalizar colores",
  "streaming.connectingTo": "Conectando a {model} (intento {attempt}/{total})...",
  "streaming.failedToPrepareAttachment": "Error al preparar el archivo adjunto reciente \"{name}\" para enviar. Inténtalo de nuevo o vuelve a adjuntar el archivo.",
  "streaming.failedToPrepareCurrent": "Error al preparar el archivo multimedia adjunto \"{name}\" para Gemini. Inténtalo de nuevo o vuelve a adjuntar el archivo.",
  "streaming.highDemand": "Alta demanda detectada. La solicitud está en cola en los servidores de Google.",
  "streaming.noOutputAfter": "Sin salida del modelo después de {seconds}s. La solicitud probablemente está en cola en los servidores de Google.",
  "streaming.phaseConnecting": "Conectando",
  "streaming.phaseFinalResponse": "Respuesta final",
  "streaming.phaseFinalizing": "Finalizando",
  "streaming.phaseHighDemand": "Alta demanda",
  "streaming.phasePreparingRequest": "Preparando solicitud",
  "streaming.phaseProcessing": "Procesando",
  "streaming.phaseRetrying": "Reintentando",
  "streaming.phaseSwitchingModel": "Cambiando modelo",
  "streaming.phaseThinking": "Pensando",
  "streaming.preparingRequestContext": "Preparando contexto de solicitud...",
  "streaming.retryingIn": "Reintentando en {seconds}s...",
  "streaming.switchingFallback": "Cambiando al modelo alternativo {model}.",
  "streaming.waitingForOutput": "Esperando la salida del modelo... {seconds}s transcurridos.",
  "textFile.rawText": "Texto sin formato",
  "textFile.unableToDecode": "No se puede decodificar el archivo de texto adjunto.",
  "themeCustomizer.cancel": "Cancelar",
  "themeCustomizer.confirm": "Confirmar",
  "themeCustomizer.deletePreset": "Eliminar preset guardado",
  "themeCustomizer.exportAs": "Exportar como",
  "themeCustomizer.exportToFile": "Exportar a archivo",
  "themeCustomizer.importFromFile": "Importar desde archivo",
  "themeCustomizer.instruction": "Toca un círculo de color y arrastra en el selector. Los cambios se aplican al instante.",
  "themeCustomizer.namePlaceholder": "Nombre del tema...",
  "themeCustomizer.quickThemes": "Temas rápidos",
  "themeCustomizer.resetAll": "Restablecer todo",
  "themeCustomizer.saveAs": "Guardar como",
  "themeCustomizer.saveAsPreset": "Guardar como preset",
  "themeCustomizer.storeDescription": "Explora y compra más temas",
  "themeCustomizer.storeTitle": "Tienda de temas",
  "themeCustomizer.title": "Paleta de colores",
  "themeStore.buy": "Comprar",
  "themeStore.close": "Cerrar",
  "themeStore.footerNote": "Las compras son gestionadas por Google Play y están vinculadas a tu cuenta de Google. Toca el botón de restaurar (↩) para recuperar compras anteriores al reinstalar.",
  "themeStore.loading": "Cargando temas…",
  "themeStore.notAvailable": "Las compras de temas solo están disponibles en Android a través de Google Play.",
  "themeStore.owned": "Adquirido",
  "themeStore.purchaseFailed": "Compra fallida. Por favor, comprueba tu conexión e inténtalo de nuevo.",
  "themeStore.restorePurchases": "Restaurar compras",
  "themeStore.title": "Tienda de temas",
};