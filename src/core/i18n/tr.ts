...
export const trTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testAppLink": " Gönderdiniz ve e-posta onayını aldınız mı? Uygulamayı buradan edinin: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "Android beta davetimizi almak için Google Play Store'da kullandığınız e-posta adresini girin!",
  "apiKeyGate.testerFormSubmit": "Erken Erişim Al",
  "apiKeyGate.testerFormSubmitting": "Gönderiliyor...",
  "apiKeyGate.testerFormSuccessTitle": "Teşekkürler!",
  "apiKeyGate.testerFormSuccessDesc": "İnsanlar e-postanızı onaylıyor. Bu biraz zaman alacaktır. Bağlantı {TheUserEmail} için anında çalışmayacaktır.",
  "apiKeyGate.testerFormNextSteps": "Onay işlemi tamamlandığında (1 güne kadar sürebilir) bu bağlantıyı size e-posta ile göndereceğiz (şimdilik bu sayfadan ayrılabilirsiniz): ",
  "apiKeyGate.testerFormError": "Bir şeyler ters gitti. Lütfen tekrar deneyin.",
  "apiKeyGate.testerFormMustBeGmail": "Google Play için lütfen bir @gmail.com adresi kullanın.",
