...
export const trTranslations: Record<string, string> = {
  ...
  "audio.play": "Oynat",
  "audio.progress": "Ses ilerleme durumu",
  "camera.observerActive": "Gözlemci aktif",
  "chat.bookmark.cancel": "İptal",
  "chat.bookmark.editAria": "Yer imi özetini düzenle",
  "chat.bookmark.hiddenBelow": "Mesajlar aşağıda gizli",
  "chat.bookmark.hiddenCount": "Yukarıdaki {count} mesaj gizlendi",
  "chat.bookmark.returnToRecent": "Aşağıdaki mesajlara dön",
  "chat.bookmark.save": "Kaydet",
  "chat.bookmark.showAboveChunk": "Yukarıdaki mesajları göster",
  "chat.bookmark.showNextChunk": "Yukarıdaki {count} mesajı göster",
  "chat.bookmark.showPreviousChunk": "Aşağıdaki {count} mesajı göster",
  "chat.bookmark.showingAboveRange": "{total} mesajın {start}-{end} aralığının üzerindekiler gösteriliyor",
  "chat.bookmark.summaryPlaceholder": "Özet...",
  "chat.camera.capturePhoto": "Fotoğraf çek",
  "chat.camera.startRecording": "Video kaydını başlat",
  "chat.deleteMessage": "Mesajı sil",
  "chat.drawMessage": "Mesaj çiz",
  "chat.focusedMode.enter": "Odak moduna gir",
  "chat.focusedMode.exit": "Odak modundan çık",
  "chat.music.finalizing": "Müzik kaydediliyor...",
  "chat.music.starting": "Müzik başlatılıyor...",
  "chat.music.streaming": "Müzik yayınlanıyor...",
  "chat.pdf.loadFailed": "PDF yüklenemedi",
  "debugLog.clearLogs": "Günlükleri temizle",
  "debugLog.clearUploads": "Mevcut API anahtarı için tüm Gemini yüklemelerini sil",
  "debugLog.close": "Kapat",
  "debugLog.error": "Hata",
  "debugLog.noTraffic": "Henüz trafik kaydedilmedi.",
  "debugLog.requestPayload": "İstek Yükü",
  "debugLog.response": "Yanıt",
  "debugLog.title": "Trafik Günlüğü",
  "error.cameraOverconstrained": "Kamera istenen ayarlarla kullanılamıyor. {errorMessage}",
  "globalProfile.ariaLabel": "Genel profil özeti",
  "globalProfile.loading": "Profil yükleniyor...",
  "globalProfile.noProfile": "Henüz profil yok.",
  "header.apiKey": "API Anahtarı",
  "header.apiKeyRequired": "API Anahtarı Gerekli",
  "header.clickToViewStatus": "Durumu görüntülemek için tıklayın",
  "header.manageApiKey": "API Anahtarını Yönet",
  "header.pauseMaestro": "Maestro'yu Duraklat",
  "header.resumeMaestro": "Maestro'yu Devam Ettir",
  "header.viewTrafficLogs": "Trafik Günlüklerini Görüntüle",
  "miniGame.codeEmpty": "Mini-oyun kodu boş.",
  "miniGame.failedToRender": "Mini-oyun oluşturulamadı.",
  "miniGame.fullscreen": "Tam ekran",
  "miniGame.hideCode": "Kodu Gizle",
  "miniGame.launching": "Mini-oyun başlatılıyor...",
  "miniGame.restart": "Yeniden Başlat",
  "miniGame.retry": "Tekrar Dene",
  "miniGame.runtimeError": "Mini-oyun hatası: {error}",
  "miniGame.showCode": "Kodu Göster",
  "miniGame.title": "Mini oyun",
  "miniGame.titleWithFile": "Mini oyun {fileName}",
  "officeFile.failedToParse": "Satır içi önizleme ayrıştırılamadı.",
  "officeFile.localPreviewUnavailable": "Yerel önizleme kullanılamıyor. Yerel olarak açmak için yeniden ekleyin.",
  "officeFile.openFile": "Dosyayı aç",
  "officeFile.openInGoogleWorkspace": "Google Workspace'te aç",
  "officeFile.parsingInlinePreview": "Satır içi önizleme ayrıştırılıyor...",
  "officeFile.parsingPreview": "Önizleme ayrıştırılıyor...",
  "officeFile.previewUnavailable": "Bu dosya için önizleme kullanılamıyor.",
  "officeFile.rawExtractedText": "Ham çıkarılan metin",
  "sessionControls.customizeColors": "Renkleri Özelleştir",
  "streaming.connectingTo": "{model} modeline bağlanıyor (deneme {attempt}/{total})...",
  "streaming.failedToPrepareAttachment": "Göndermek için son ek \"{name}\" hazırlanamadı. Tekrar deneyin veya dosyayı yeniden ekleyin.",
  "streaming.failedToPrepareCurrent": "Ekli medya \"{name}\" Gemini için hazırlanamadı. Tekrar deneyin veya dosyayı yeniden ekleyin.",
  "streaming.highDemand": "Yüksek talep algılandı. İstek Google sunucularında sıraya alındı.",
  "streaming.noOutputAfter": "{seconds}s sonra model çıktısı yok. İstek muhtemelen Google sunucularında sırada bekliyor.",
  "streaming.phaseConnecting": "Bağlanıyor",
  "streaming.phaseFinalResponse": "Son yanıt",
  "streaming.phaseFinalizing": "Sonlandırılıyor",
  "streaming.phaseHighDemand": "Yüksek talep",
  "streaming.phasePreparingRequest": "İstek hazırlanıyor",
  "streaming.phaseProcessing": "İşleniyor",
  "streaming.phaseRetrying": "Yeniden deneniyor",
  "streaming.phaseSwitchingModel": "Model değiştiriliyor",
  "streaming.phaseThinking": "Düşünüyor",
  "streaming.preparingRequestContext": "İstek bağlamı hazırlanıyor...",
  "streaming.retryingIn": "{seconds}s içinde yeniden deneniyor...",
  "streaming.switchingFallback": "Yedek model {model}'e geçiliyor.",
  "streaming.waitingForOutput": "Model çıktısı bekleniyor... {seconds}s geçti.",
  "textFile.rawText": "Ham metin",
  "textFile.unableToDecode": "Metin eki çözümlenemiyor.",
  "themeCustomizer.cancel": "İptal",
  "themeCustomizer.confirm": "Onayla",
  "themeCustomizer.deletePreset": "Kaydedilen önayarı sil",
  "themeCustomizer.exportAs": "Farklı dışa aktar",
  "themeCustomizer.exportToFile": "Dosyaya dışa aktar",
  "themeCustomizer.importFromFile": "Dosyadan içe aktar",
  "themeCustomizer.instruction": "Bir renk dairesine dokunun, ardından seçicide sürükleyin. Değişiklikler anında uygulanır.",
  "themeCustomizer.namePlaceholder": "Tema adı...",
  "themeCustomizer.quickThemes": "Hızlı Temalar",
  "themeCustomizer.resetAll": "Tümünü Sıfırla",
  "themeCustomizer.saveAs": "Farklı kaydet",
  "themeCustomizer.saveAsPreset": "Önayar olarak kaydet",
  "themeCustomizer.storeDescription": "Daha fazla tema göz atın ve satın alın",
  "themeCustomizer.storeTitle": "Tema Mağazası",
  "themeCustomizer.title": "Renkleri Boyayın",
  "themeStore.buy": "Satın Al",
  "themeStore.close": "Kapat",
  "themeStore.footerNote": "Satın almalar Google Play tarafından yönetilir ve Google hesabınıza bağlıdır. Yeniden kurulumdan sonra geçmiş satın almaları kurtarmak için geri yükleme düğmesine (↩) dokunun.",
  "themeStore.loading": "Temalar yükleniyor…",
  "themeStore.notAvailable": "Tema satın almaları yalnızca Google Play üzerinden Android'de kullanılabilir.",
  "themeStore.owned": "Sahip olunan",
  "themeStore.purchaseFailed": "Satın alma başarısız. Lütfen bağlantınızı kontrol edin ve tekrar deneyin.",
  "themeStore.restorePurchases": "Satın Almaları Geri Yükle",
  "themeStore.title": "Tema Mağazası",
};