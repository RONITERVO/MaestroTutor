...
export const idTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testerFormTitle": "Uji Aplikasi",
  "apiKeyGate.testAppLink": " Sudah mengirim dan menerima email konfirmasi? Dapatkan aplikasinya di sini: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "Masukkan email yang Anda gunakan untuk Google Play Store untuk mendapatkan undangan ke versi beta Android kami!",
  "apiKeyGate.testerFormSubmit": "Dapatkan Akses Awal",
  "apiKeyGate.testerFormSubmitting": "Mengirim...",
  "apiKeyGate.testerFormSuccessTitle": "Terima kasih!",
  "apiKeyGate.testerFormSuccessDesc": "Tim kami sedang mengonfirmasi email Anda. Ini akan memakan waktu. Tautan ini tidak akan langsung berfungsi untuk {TheUserEmail}.",
  "apiKeyGate.testerFormNextSteps": "Saat konfirmasi selesai (hingga 1 hari), kami akan mengirimkan tautan ini melalui email (Anda dapat meninggalkan halaman ini untuk saat ini): ",
