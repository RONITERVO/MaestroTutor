...
export const viTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testAppLink": " Đã gửi và nhận được email xác nhận? Tải ứng dụng tại đây: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "Nhập email bạn sử dụng cho Cửa hàng Google Play để nhận lời mời trải nghiệm bản beta dành cho Android của chúng tôi!",
  "apiKeyGate.testerFormSubmit": "Nhận quyền truy cập sớm",
  "apiKeyGate.testerFormSubmitting": "Đang gửi...",
  "apiKeyGate.testerFormSuccessTitle": "Cảm ơn!",
  "apiKeyGate.testerFormSuccessDesc": "Con người đang xác nhận email của bạn. Việc này sẽ mất thời gian. Liên kết sẽ không hoạt động ngay lập tức đối với {TheUserEmail}.",
  "apiKeyGate.testerFormNextSteps": "Khi quá trình xác nhận hoàn tất (tối đa 1 ngày), chúng tôi sẽ gửi email cho bạn liên kết này (bạn có thể rời khỏi trang này bây giờ): ",
