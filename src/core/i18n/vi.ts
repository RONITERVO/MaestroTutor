...
export const viTranslations: Record<string, string> = {
  ...
  "audio.play": "Phát",
  "audio.progress": "Tiến trình âm thanh",
  "camera.observerActive": "Trình quan sát đang hoạt động",
  "chat.bookmark.cancel": "Hủy",
  "chat.bookmark.editAria": "Chỉnh sửa tóm tắt dấu trang",
  "chat.bookmark.hiddenBelow": "Tin nhắn bị ẩn bên dưới",
  "chat.bookmark.hiddenCount": "{count} tin nhắn phía trên bị ẩn",
  "chat.bookmark.returnToRecent": "Quay lại tin nhắn bên dưới",
  "chat.bookmark.save": "Lưu",
  "chat.bookmark.showAboveChunk": "Hiển thị tin nhắn phía trên",
  "chat.bookmark.showNextChunk": "Hiển thị {count} phía trên",
  "chat.bookmark.showPreviousChunk": "Hiển thị {count} phía dưới",
  "chat.bookmark.showingAboveRange": "Đang hiển thị tin nhắn phía trên {start}-{end} trong {total}",
  "chat.bookmark.summaryPlaceholder": "Tóm tắt...",
  "chat.camera.capturePhoto": "Chụp ảnh",
  "chat.camera.startRecording": "Bắt đầu quay video",
  "chat.deleteMessage": "Xóa tin nhắn",
  "chat.drawMessage": "Vẽ tin nhắn",
  "chat.focusedMode.enter": "Vào chế độ tập trung",
  "chat.focusedMode.exit": "Thoát chế độ tập trung",
  "chat.music.finalizing": "Đang lưu nhạc...",
  "chat.music.starting": "Đang bắt đầu nhạc...",
  "chat.music.streaming": "Đang phát nhạc...",
  "chat.pdf.loadFailed": "Không thể tải PDF",
  "debugLog.clearLogs": "Xóa nhật ký",
  "debugLog.clearUploads": "Xóa tất cả tệp tải lên Gemini cho khóa API hiện tại",
  "debugLog.close": "Đóng",
  "debugLog.error": "Lỗi",
  "debugLog.noTraffic": "Chưa có lưu lượng nào được ghi lại.",
  "debugLog.requestPayload": "Tải trọng yêu cầu",
  "debugLog.response": "Phản hồi",
  "debugLog.title": "Nhật ký lưu lượng",
  "error.cameraOverconstrained": "Camera không khả dụng với các cài đặt yêu cầu. {errorMessage}",
  "globalProfile.ariaLabel": "Tóm tắt hồ sơ toàn cầu",
  "globalProfile.loading": "Đang tải hồ sơ...",
  "globalProfile.noProfile": "Chưa có hồ sơ.",
  "header.apiKey": "Khóa API",
  "header.apiKeyRequired": "Yêu cầu khóa API",
  "header.clickToViewStatus": "Nhấp để xem trạng thái",
  "header.manageApiKey": "Quản lý khóa API",
  "header.pauseMaestro": "Tạm dừng Maestro",
  "header.resumeMaestro": "Tiếp tục Maestro",
  "header.viewTrafficLogs": "Xem nhật ký lưu lượng",
  "miniGame.codeEmpty": "Mã mini-game trống.",
  "miniGame.failedToRender": "Mini-game không thể hiển thị.",
  "miniGame.fullscreen": "Toàn màn hình",
  "miniGame.hideCode": "Ẩn mã",
  "miniGame.launching": "Đang khởi chạy mini-game...",
  "miniGame.restart": "Khởi động lại",
  "miniGame.retry": "Thử lại",
  "miniGame.runtimeError": "Lỗi mini-game: {error}",
  "miniGame.showCode": "Hiển thị mã",
  "miniGame.title": "Mini game",
  "miniGame.titleWithFile": "Mini game {fileName}",
  "officeFile.failedToParse": "Không thể phân tích xem trước nội tuyến.",
  "officeFile.localPreviewUnavailable": "Xem trước cục bộ không khả dụng. Đính kèm lại để mở cục bộ.",
  "officeFile.openFile": "Mở tệp",
  "officeFile.openInGoogleWorkspace": "Mở trong Google Workspace",
  "officeFile.parsingInlinePreview": "Đang phân tích xem trước nội tuyến...",
  "officeFile.parsingPreview": "Đang phân tích xem trước...",
  "officeFile.previewUnavailable": "Xem trước không khả dụng cho tệp này.",
  "officeFile.rawExtractedText": "Văn bản thô đã trích xuất",
  "sessionControls.customizeColors": "Tùy chỉnh màu sắc",
  "streaming.connectingTo": "Đang kết nối đến {model} (lần thử {attempt}/{total})...",
  "streaming.failedToPrepareAttachment": "Không thể chuẩn bị tệp đính kèm gần đây \"{name}\" để gửi. Thử lại hoặc đính kèm lại tệp.",
  "streaming.failedToPrepareCurrent": "Không thể chuẩn bị tệp phương tiện đính kèm \"{name}\" cho Gemini. Thử lại hoặc đính kèm lại tệp.",
  "streaming.highDemand": "Phát hiện nhu cầu cao. Yêu cầu đang được xếp hàng trên máy chủ Google.",
  "streaming.noOutputAfter": "Không có kết quả mô hình sau {seconds} giây. Yêu cầu có thể đang được xếp hàng trên máy chủ Google.",
  "streaming.phaseConnecting": "Đang kết nối",
  "streaming.phaseFinalResponse": "Phản hồi cuối cùng",
  "streaming.phaseFinalizing": "Đang hoàn thiện",
  "streaming.phaseHighDemand": "Nhu cầu cao",
  "streaming.phasePreparingRequest": "Đang chuẩn bị yêu cầu",
  "streaming.phaseProcessing": "Đang xử lý",
  "streaming.phaseRetrying": "Đang thử lại",
  "streaming.phaseSwitchingModel": "Đang chuyển mô hình",
  "streaming.phaseThinking": "Đang suy nghĩ",
  "streaming.preparingRequestContext": "Đang chuẩn bị ngữ cảnh yêu cầu...",
  "streaming.retryingIn": "Thử lại sau {seconds} giây...",
  "streaming.switchingFallback": "Đang chuyển sang mô hình dự phòng {model}.",
  "streaming.waitingForOutput": "Đang chờ kết quả mô hình... đã qua {seconds} giây.",
  "textFile.rawText": "Văn bản thô",
  "textFile.unableToDecode": "Không thể giải mã tệp đính kèm văn bản.",
  "themeCustomizer.cancel": "Hủy",
  "themeCustomizer.confirm": "Xác nhận",
  "themeCustomizer.deletePreset": "Xóa cài đặt sẵn đã lưu",
  "themeCustomizer.exportAs": "Xuất dưới dạng",
  "themeCustomizer.exportToFile": "Xuất ra tệp",
  "themeCustomizer.importFromFile": "Nhập từ tệp",
  "themeCustomizer.instruction": "Nhấn vào vòng tròn màu, rồi kéo trong bộ chọn. Thay đổi áp dụng ngay lập tức.",
  "themeCustomizer.namePlaceholder": "Tên chủ đề...",
  "themeCustomizer.quickThemes": "Chủ đề nhanh",
  "themeCustomizer.resetAll": "Đặt lại tất cả",
  "themeCustomizer.saveAs": "Lưu dưới dạng",
  "themeCustomizer.saveAsPreset": "Lưu dưới dạng cài đặt sẵn",
  "themeCustomizer.storeDescription": "Duyệt và mua thêm chủ đề",
  "themeCustomizer.storeTitle": "Cửa hàng chủ đề",
  "themeCustomizer.title": "Màu sắc",
  "themeStore.buy": "Mua",
  "themeStore.close": "Đóng",
  "themeStore.footerNote": "Giao dịch mua được quản lý bởi Google Play và liên kết với tài khoản Google của bạn. Nhấn nút khôi phục (↩) để khôi phục các giao dịch mua trước đó sau khi cài đặt lại.",
  "themeStore.loading": "Đang tải chủ đề…",
  "themeStore.notAvailable": "Mua chủ đề chỉ khả dụng trên Android qua Google Play.",
  "themeStore.owned": "Đã sở hữu",
  "themeStore.purchaseFailed": "Mua không thành công. Vui lòng kiểm tra kết nối và thử lại.",
  "themeStore.restorePurchases": "Khôi phục giao dịch mua",
  "themeStore.title": "Cửa hàng chủ đề",
};