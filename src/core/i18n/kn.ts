...
export const knTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testerFormTitle": "ಅಪ್ಲಿಕೇಶನ್ ಅನ್ನು ಪರೀಕ್ಷಿಸಿ",
  "apiKeyGate.testAppLink": " ಸಲ್ಲಿಸಿದ್ದೀರಾ ಮತ್ತು ಇಮೇಲ್ ದೃಢೀಕರಣವನ್ನು ಸ್ವೀಕರಿಸಿದ್ದೀರಾ? ಅಪ್ಲಿಕೇಶನ್ ಅನ್ನು ಇಲ್ಲಿ ಪಡೆಯಿರಿ: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "ನಮ್ಮ ಆಂಡ್ರಾಯ್ಡ್ ಬೀಟಾ ಆಹ್ವಾನವನ್ನು ಪಡೆಯಲು ನೀವು Google Play Store ಗಾಗಿ ಬಳಸುವ ಇಮೇಲ್ ಅನ್ನು ನಮೂದಿಸಿ!",
  "apiKeyGate.testerFormSubmit": "ಆರಂಭಿಕ ಪ್ರವೇಶ ಪಡೆಯಿರಿ",
  "apiKeyGate.testerFormSubmitting": "ಕಳುಹಿಸಲಾಗುತ್ತಿದೆ...",
  "apiKeyGate.testerFormSuccessTitle": "ಧನ್ಯವಾದಗಳು!",
  "apiKeyGate.testerFormSuccessDesc": "ಮನುಷ್ಯರು ನಿಮ್ಮ ಇಮೇಲ್ ಅನ್ನು ದೃಢೀಕರಿಸುತ್ತಿದ್ದಾರೆ. ಇದಕ್ಕೆ ಸ್ವಲ್ಪ ಸಮಯ ತೆಗೆದುಕೊಳ್ಳುತ್ತದೆ. ಈ ಲಿಂಕ್ {TheUserEmail} ಗೆ ತಕ್ಷಣವೇ ಕಾರ್ಯನಿರ್ವಹಿಸುವುದಿಲ್ಲ.",
  "apiKeyGate.testerFormNextSteps": "ದೃಢೀಕರಣ ಪೂರ್ಣಗೊಂಡಾಗ (1 ದಿನದವರೆಗೆ) ನಾವು ಈ ಲಿಂಕ್ ಅನ್ನು ನಿಮಗೆ ಇಮೇಲ್ ಮಾಡುತ್ತೇವೆ (ನೀವು ಇದೀಗ ಈ ಪುಟದಿಂದ ನಿರ್ಗಮಿಸಬಹುದು): ",
  "apiKeyGate.testerFormError": "ಏನೋ ತಪ್ಪಾಗಿದೆ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.",
  "apiKeyGate.testerFormMustBeGmail": "ದಯವಿಟ್ಟು Google Play ಗಾಗಿ @gmail.com ವಿಳಾಸವನ್ನು ಬಳಸಿ.",
