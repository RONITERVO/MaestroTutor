...
export const enTranslations: Record<string, string> = {
  ...
  "managedAccess.balanceLabel": "Available balance",
  "managedAccess.spentLabel": "Lifetime usage",
  ...
  "managedAccess.purchasing": "Opening checkout…",
  "managedAccess.packTitle": "Maestro credit pack",
  "managedAccess.packDescription": "Credits work across managed Maestro features.",
  "managedAccess.keepByok": "Your own Gemini API key remains available as a separate access option.",
  "managedAccess.billingNote": "Stripe Checkout is the only managed-credit purchase path. Credits are shared across signed-in devices.",
  "managedAccess.androidOnly": "Purchasing is unavailable on this platform.",
  "managedAccess.checkoutComplete": "Payment received. Adding your credits…",
  "managedAccess.checkoutReturn": "Checking Stripe for completed payment and updated credits…",
  "managedAccess.signInRequired": "Sign in before using managed billing.",
  "managedAccess.productMissing": "No managed credit pack is configured.",
  "managedAccess.signInFailed": "Google sign-in failed.",
  "managedAccess.signOutFailed": "Sign-out failed.",
  "managedAccess.refreshFailed": "Could not refresh the managed account.",
  "managedAccess.purchaseFailed": "Could not start the purchase.",
  "managedAccess.purchaseSyncFailed": "The purchase could not be reconciled yet.",
  "managedAccess.billingUnavailable": "Managed checkout is unavailable.",
  "managedAccess.genericError": "Managed billing encountered an error.",
  "managedAccess.deleteTitle": "Delete managed account",
  "managedAccess.deleteDescription": "Permanently delete the managed account and its Maestro server data.",
  "managedAccess.deleteAction": "Delete account",
  "managedAccess.deleteConfirmHint": "Type DELETE to confirm.",
  "managedAccess.deleteCancel": "Cancel",
  "managedAccess.deleteConfirm": "Delete permanently",
  "managedAccess.deleting": "Deleting…",
  "managedAccess.deleteNeedsConfirmation": "Type DELETE before continuing.",
  "managedAccess.deleteSuccess": "The managed account was deleted.",
  "managedAccess.deleteFailed": "Could not delete the managed account.",
  ...
  "managedAccess.activityLoading": "Loading account activity…",
  "managedAccess.activityLoadFailed": "Could not load account activity.",
  "managedAccess.activityEmpty": "No entries yet.",
  "managedAccess.usageLedgerTitle": "Usage",
  "managedAccess.billingLedgerTitle": "Credits and purchases",

  // AI content reports
  "chat.report.title": "Report this response",
  "chat.report.close": "Close report",
  "chat.report.reasonLabel": "Reason",
  "chat.report.previewLabel": "Response preview",
  "chat.report.noPreview": "No text preview is available.",
  "chat.report.notesLabel": "Additional notes",
  "chat.report.notesPlaceholder": "Optional context for the report",
  ...
  "chat.report.action": "Report response",
  "chat.report.failed": "Could not submit the report.",
  "chat.report.reason.sexual": "Sexual content",
  "chat.report.reason.hate": "Hate",
  "chat.report.reason.harassment": "Harassment",
  "chat.report.reason.self-harm": "Self-harm",
  "chat.report.reason.violent": "Violence",
  "chat.report.reason.deceptive": "Deceptive content",
  ...
  "costBreakdown.modelUsage": "Model usage",
  "costBreakdown.searchMaximum": "Potential Search",
  "costBreakdown.usageTotals": "Usage totals",
  "costBreakdown.inputTokens": "Input tokens",
  "costBreakdown.outputTokens": "Output tokens",
  "costBreakdown.thinkingTokens": "Thinking tokens",
  "costBreakdown.cachedTokens": "Cached input tokens",
  "costBreakdown.images": "Generated images",
  "costBreakdown.generatedAudio": "Generated audio",
  "costBreakdown.searchPrompts": "Grounded prompts",
  "costBreakdown.searchQueries": "Search queries",
  "costBreakdown.modality.text": "Text",
  "costBreakdown.modality.audio": "Audio",
  "costBreakdown.modality.image": "Image",
  "costBreakdown.modality.video": "Video",
  "costBreakdown.modality.document": "Document",
  "costBreakdown.modalitySummary": "{modality} {input} in / {output} out",
  "costBreakdown.byActivity": "Cost by activity",
  "costBreakdown.trackingSince": "Tracking since {date}",
  "costBreakdown.rateDate": "Rates effective {date}",
  "costBreakdown.entryRateDate": "Priced with rates effective {date}.",
  "costBreakdown.noNewUsage": "No usage has been recorded with the accurate tracker yet.",
  "costBreakdown.requestSingle": "1 request",
  "costBreakdown.requests": "{count} requests",
  "costBreakdown.unpriced": "Not priced",
  "costBreakdown.feature.tutor": "Tutor conversations",
  "costBreakdown.feature.suggestions": "Reply suggestions",
  "costBreakdown.feature.translation": "Translations",
  "costBreakdown.feature.image": "Image generation",
  "costBreakdown.feature.liveConversation": "Live conversations",
  "costBreakdown.feature.reengagement": "Live re-engagement",
  "costBreakdown.feature.stt": "Speech recognition",
  "costBreakdown.feature.tts": "Spoken replies",
  "costBreakdown.feature.audioNote": "Audio notes",
  "costBreakdown.feature.music": "Music generation",
  "costBreakdown.searchAllowanceTitle": "Google Search has a shared monthly allowance",
  "costBreakdown.searchAllowanceBody": "This device recorded {prompts} grounded prompts and {queries} individual queries. {cost} is the maximum list price before Google's 5,000-prompt monthly allowance, which is shared across your Gemini 3 project usage.",
  "costBreakdown.legacyTitle": "Earlier app estimate: {cost} (not included)",
  "costBreakdown.legacyBody": "The earlier tracker did not record enough detail to recalculate this accurately, so it is preserved separately instead of being mixed into the new total.",
  "costBreakdown.howCalculated": "What this estimate means",
  "costBreakdown.scopePaid": "Uses Google's Standard paid-tier USD list prices, including thinking, cached, tool-use, and modality-specific tokens.",
  "costBreakdown.scopeDevice": "Covers usage made by this installation since the date shown; other browsers, devices, apps, and deleted local data are not visible here.",
  "costBreakdown.scopeMetadata": "Uses the actual response model and Gemini usage metadata whenever the API provides them. Unknown prices are shown as unpriced, never silently treated as free.",
  "costBreakdown.scopeDiscounts": "Free-tier usage, monthly allowances, taxes, credits, negotiated rates, Batch/Flex/Priority pricing, and Google-side adjustments can make the final bill lower or higher.",
  "costBreakdown.viewPricingSource": "View Google's pricing used by this estimate",
  "costBreakdown.billingAuthority": "Google Cloud Billing remains the authoritative invoice and project-wide total.",
  "costBreakdown.openGoogleBilling": "Verify in Google Billing",
  ...
  "chat.maestro.localListening": "Listening locally...",
  "chat.maestro.title.localListening": "Local voice activity detection is waiting for speech. Gemini Live is not connected.",
  "chat.maestro.whisperLoading": "Preparing speech detection...",
  "chat.maestro.title.whisperLoading": "The local Whisper model is loading. Gemini Live is not connected.",
  "chat.maestro.whisperChecking": "Noting your speech...",
  "chat.maestro.title.whisperChecking": "Local Whisper is checking the retained speech before Gemini Live can connect.",
  "chat.maestro.whisperTriggered": "Speech noted",
  "chat.maestro.title.whisperTriggered": "Local Whisper found words and authorized this Live connection.",
  "chat.maestro.liveConnecting": "Connecting Live...",
  "chat.maestro.title.liveConnecting": "An authorized Gemini Live transport is connecting.",
  "chat.maestro.liveActive": "Live listening active",
  "chat.maestro.title.liveActive": "Gemini Live is connected after a logged speech trigger.",
