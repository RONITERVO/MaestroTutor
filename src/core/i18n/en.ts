...
export const enTranslations: Record<string, string> = {
  ...
  "managedAccess.billingNote": "Web purchases use Stripe; Android purchases use Google Play Billing.",
  ...
  "managedAccess.billingUnavailable": "Google Play Billing is unavailable.",
  "managedAccess.restoreFailed": "Could not restore purchases.",
