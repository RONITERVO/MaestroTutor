...
export const enTranslations: Record<string, string> = {
  ...
  "apiKeyGate.reenableGoogleSearch": "Try Google Search again",
  ...
  "costBreakdown.smartSearchTitle": "Smart Search compatibility",
  "costBreakdown.smartSearchMonitoring": "Automatic",
  "costBreakdown.smartSearchDisabled": "Search off",
  "costBreakdown.smartSearchNoCharge": "No Search charge",
  "costBreakdown.smartSearchEnabledBody": "Google does not expose the key's billing tier. Maestro tests Search only when needed; if it is unavailable, the same request is retried without Search and that choice is remembered.",
  "costBreakdown.smartSearchDisabledBody": "Search was unavailable, so Maestro completed the request without it and kept Search off. You can try it again from the API key screen after upgrading.",
