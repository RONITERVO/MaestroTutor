...
export const arTranslations: Record<string, string> = {
  ...
  "audio.play": "تشغيل",
  "audio.progress": "تقدم الصوت",
  "camera.observerActive": "المراقب نشط",
  "chat.bookmark.cancel": "إلغاء",
  "chat.bookmark.editAria": "تعديل ملخص الإشارة المرجعية",
  "chat.bookmark.hiddenBelow": "الرسائل مخفية أدناه",
  "chat.bookmark.hiddenCount": "{count} رسائل أعلاه مخفية",
  "chat.bookmark.returnToRecent": "العودة إلى الرسائل أدناه",
  "chat.bookmark.save": "حفظ",
  "chat.bookmark.showAboveChunk": "عرض الرسائل أعلاه",
  "chat.bookmark.showNextChunk": "عرض {count} أعلاه",
  "chat.bookmark.showPreviousChunk": "عرض {count} أدناه",
  "chat.bookmark.showingAboveRange": "عرض الرسائل أعلاه {start}-{end} من {total}",
  "chat.bookmark.summaryPlaceholder": "ملخص...",
  "chat.camera.capturePhoto": "التقاط صورة",
  "chat.camera.startRecording": "بدء تسجيل الفيديو",
  "chat.deleteMessage": "حذف الرسالة",
  "chat.drawMessage": "رسم الرسالة",
  "chat.focusedMode.enter": "الدخول إلى وضع التركيز",
  "chat.focusedMode.exit": "الخروج من وضع التركيز",
  "chat.music.finalizing": "جارٍ حفظ الموسيقى...",
  "chat.music.starting": "جارٍ بدء الموسيقى...",
  "chat.music.streaming": "جارٍ بث الموسيقى...",
  "chat.pdf.loadFailed": "فشل تحميل PDF",
  "debugLog.clearLogs": "مسح السجلات",
  "debugLog.clearUploads": "حذف جميع رفعات Gemini لمفتاح API الحالي",
  "debugLog.close": "إغلاق",
  "debugLog.error": "خطأ",
  "debugLog.noTraffic": "لم يتم تسجيل أي حركة بيانات بعد.",
  "debugLog.requestPayload": "حمولة الطلب",
  "debugLog.response": "الاستجابة",
  "debugLog.title": "سجل حركة البيانات",
  "error.cameraOverconstrained": "الكاميرا غير متاحة بالإعدادات المطلوبة. {errorMessage}",
  "globalProfile.ariaLabel": "ملخص الملف الشخصي العام",
  "globalProfile.loading": "جارٍ تحميل الملف الشخصي...",
  "globalProfile.noProfile": "لا يوجد ملف شخصي بعد.",
  "header.apiKey": "مفتاح API",
  "header.apiKeyRequired": "مفتاح API مطلوب",
  "header.clickToViewStatus": "انقر لعرض الحالة",
  "header.manageApiKey": "إدارة مفتاح API",
  "header.pauseMaestro": "إيقاف Maestro مؤقتاً",
  "header.resumeMaestro": "استئناف Maestro",
  "header.viewTrafficLogs": "عرض سجلات حركة البيانات",
  "miniGame.codeEmpty": "كود اللعبة المصغرة فارغ.",
  "miniGame.failedToRender": "فشل عرض اللعبة المصغرة.",
  "miniGame.fullscreen": "ملء الشاشة",
  "miniGame.hideCode": "إخفاء الكود",
  "miniGame.launching": "جارٍ تشغيل اللعبة المصغرة...",
  "miniGame.restart": "إعادة التشغيل",
  "miniGame.retry": "إعادة المحاولة",
  "miniGame.runtimeError": "خطأ في اللعبة المصغرة: {error}",
  "miniGame.showCode": "عرض الكود",
  "miniGame.title": "لعبة مصغرة",
  "miniGame.titleWithFile": "لعبة مصغرة {fileName}",
  "officeFile.failedToParse": "فشل تحليل المعاينة المضمّنة.",
  "officeFile.localPreviewUnavailable": "المعاينة المحلية غير متاحة. أعد الإرفاق للفتح محلياً.",
  "officeFile.openFile": "فتح الملف",
  "officeFile.openInGoogleWorkspace": "فتح في Google Workspace",
  "officeFile.parsingInlinePreview": "جارٍ تحليل المعاينة المضمّنة...",
  "officeFile.parsingPreview": "جارٍ تحليل المعاينة...",
  "officeFile.previewUnavailable": "المعاينة غير متاحة لهذا الملف.",
  "officeFile.rawExtractedText": "النص المستخرج الخام",
  "sessionControls.customizeColors": "تخصيص الألوان",
  "streaming.connectingTo": "جارٍ الاتصال بـ {model} (المحاولة {attempt}/{total})...",
  "streaming.failedToPrepareAttachment": "فشل تحضير المرفق الأخير «{name}» للإرسال. حاول مرة أخرى أو أعد إرفاق الملف.",
  "streaming.failedToPrepareCurrent": "فشل تحضير الوسائط المرفقة «{name}» لـ Gemini. حاول مرة أخرى أو أعد إرفاق الملف.",
  "streaming.highDemand": "تم رصد طلب مرتفع. الطلب في قائمة الانتظار على خوادم Google.",
  "streaming.noOutputAfter": "لا يوجد إخراج من النموذج بعد {seconds} ثانية. الطلب على الأرجح في قائمة الانتظار على خوادم Google.",
  "streaming.phaseConnecting": "جارٍ الاتصال",
  "streaming.phaseFinalResponse": "الاستجابة النهائية",
  "streaming.phaseFinalizing": "جارٍ الإنهاء",
  "streaming.phaseHighDemand": "طلب مرتفع",
  "streaming.phasePreparingRequest": "جارٍ تحضير الطلب",
  "streaming.phaseProcessing": "جارٍ المعالجة",
  "streaming.phaseRetrying": "جارٍ إعادة المحاولة",
  "streaming.phaseSwitchingModel": "جارٍ التبديل إلى نموذج آخر",
  "streaming.phaseThinking": "جارٍ التفكير",
  "streaming.preparingRequestContext": "جارٍ تحضير سياق الطلب...",
  "streaming.retryingIn": "إعادة المحاولة خلال {seconds} ثانية...",
  "streaming.switchingFallback": "جارٍ التبديل إلى النموذج الاحتياطي {model}.",
  "streaming.waitingForOutput": "في انتظار إخراج النموذج... مضى {seconds} ثانية.",
  "textFile.rawText": "النص الخام",
  "textFile.unableToDecode": "تعذّر فك تشفير مرفق النص.",
  "themeCustomizer.cancel": "إلغاء",
  "themeCustomizer.confirm": "تأكيد",
  "themeCustomizer.deletePreset": "حذف الإعداد المسبق المحفوظ",
  "themeCustomizer.exportAs": "تصدير باسم",
  "themeCustomizer.exportToFile": "تصدير إلى ملف",
  "themeCustomizer.importFromFile": "استيراد من ملف",
  "themeCustomizer.instruction": "انقر على دائرة لون، ثم اسحب في المحدد. تُطبَّق التغييرات فوراً.",
  "themeCustomizer.namePlaceholder": "اسم السمة...",
  "themeCustomizer.quickThemes": "سمات سريعة",
  "themeCustomizer.resetAll": "إعادة تعيين الكل",
  "themeCustomizer.saveAs": "حفظ باسم",
  "themeCustomizer.saveAsPreset": "حفظ كإعداد مسبق",
  "themeCustomizer.storeDescription": "تصفح واشترِ المزيد من السمات",
  "themeCustomizer.storeTitle": "متجر السمات",
  "themeCustomizer.title": "ألوان الطلاء",
  "themeStore.buy": "شراء",
  "themeStore.close": "إغلاق",
  "themeStore.footerNote": "تتم إدارة المشتريات بواسطة Google Play وترتبط بحساب Google الخاص بك. انقر على زر الاستعادة (↩) لاسترداد المشتريات السابقة عند إعادة التثبيت.",
  "themeStore.loading": "جارٍ تحميل السمات…",
  "themeStore.notAvailable": "مشتريات السمات متاحة فقط على Android عبر Google Play.",
  "themeStore.owned": "مملوك",
  "themeStore.purchaseFailed": "فشلت عملية الشراء. يرجى التحقق من اتصالك والمحاولة مرة أخرى.",
  "themeStore.restorePurchases": "استعادة المشتريات",
  "themeStore.title": "متجر السمات",
};