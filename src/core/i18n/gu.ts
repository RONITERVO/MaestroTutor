...
export const guTranslations: Record<string, string> = {
  ...
  // New UI strings
  "app.loading": "એપ લોડ થઈ રહ્યું છે...",
  "audio.loading": "ઓડિઓ લોડ થઈ રહ્યું છે",
  "audio.pause": "રોકો",
  "audio.play": "ચલાવો",
  "audio.progress": "ઓડિઓ પ્રગતિ",
  "camera.observerActive": "ઓબ્ઝર્વર સક્રિય",
  "chat.bookmark.cancel": "રદ કરો",
  "chat.bookmark.editAria": "બુકમાર્ક સારાંશ સંપાદિત કરો",
  "chat.bookmark.hiddenBelow": "નીચે સંદેશા છુપાયેલ છે",
  "chat.bookmark.hiddenCount": "{count} ઉપરના સંદેશા છુપાયેલ",
  "chat.bookmark.returnToRecent": "નીચેના સંદેશા પર પાછા જાઓ",
  "chat.bookmark.save": "સાચવો",
  "chat.bookmark.showAboveChunk": "ઉપરના સંદેશા બતાવો",
  "chat.bookmark.showNextChunk": "ઉપર {count} બતાવો",
  "chat.bookmark.showPreviousChunk": "નીચે {count} બતાવો",
  "chat.bookmark.showingAboveRange": "{total} માંથી {start}-{end} ના ઉપરના સંદેશા બતાવ્યા",
  "chat.bookmark.summaryPlaceholder": "સારાંશ...",
  "chat.camera.capturePhoto": "ફોટો લો",
  "chat.camera.startRecording": "વિડિઓ રેકોર્ડિંગ શરૂ કરો",
  "chat.deleteMessage": "સંદેશ ભૂંસો",
  "chat.drawMessage": "સંદેશ દોરો",
  "chat.focusedMode.enter": "ફોકસ્ડ મોડ ચાલુ કરો",
  "chat.focusedMode.exit": "ફોકસ્ડ મોડ બંધ કરો",
  "chat.music.finalizing": "સંગીત સાચવ્યું...",
  "chat.music.starting": "સંગીત શરૂ...",
  "chat.music.streaming": "સંગીત સ્ટ્રીમ...",
  "chat.pdf.loadFailed": "PDF લોડ કરવામાં નિષ્ફળ",
  "debugLog.clearLogs": "લૉગ સાફ કરો",
  "debugLog.clearUploads": "વર્તમાન API કી માટે બધા Gemini અપલોડ કાઢો",
  "debugLog.close": "બંધ કરો",
  "debugLog.error": "ભૂલ",
  "debugLog.noTraffic": "હજુ સુધી કોઈ ટ્રાફિક નોંધ્યો નથી.",
  "debugLog.requestPayload": "વિનંતી પેલોડ",
  "debugLog.response": "પ્રતિભાવ",
  "debugLog.title": "ટ્રાફિક લૉગ",
  "error.cameraOverconstrained": "વિનંતી કરેલ સેટિંગ્સ સાથે કૅમેરા ઉપલબ્ધ નથી. {errorMessage}",
  "globalProfile.ariaLabel": "ગ્લોબલ પ્રોફાઇલ સારાંશ",
  "globalProfile.loading": "પ્રોફાઇલ લોડ થઈ રહ્યું છે...",
  "globalProfile.noProfile": "હજુ સુધી કોઈ પ્રોફાઇલ નથી.",
  "header.apiKey": "API કી",
  "header.apiKeyRequired": "API કી જરૂરી છે",
  "header.clickToViewStatus": "સ્ટેટસ જોવા ક્લિક કરો",
  "header.manageApiKey": "API કી સંચાલિત કરો",
  "header.pauseMaestro": "Maestro રોકો",
  "header.resumeMaestro": "Maestro ફરી શરૂ કરો",
  "header.viewTrafficLogs": "ટ્રાફિક લૉગ જુઓ",
  "miniGame.codeEmpty": "મિની-ગેમ કોડ ખાલી છે.",
  "miniGame.failedToRender": "મિની-ગેમ રેન્ડર કરવામાં નિષ્ફળ.",
  "miniGame.fullscreen": "સ્ક્રીન ભરો",
  "miniGame.hideCode": "કોડ છુપાવો",
  "miniGame.launching": "મિની-ગેમ ચાલુ...",
  "miniGame.restart": "ફરી શરૂ",
  "miniGame.retry": "ફરી પ્રયાસ",
  "miniGame.runtimeError": "મિની-ગેમ ભૂલ: {error}",
  "miniGame.showCode": "કોડ બતાવો",
  "miniGame.title": "મિની ગેમ",
  "miniGame.titleWithFile": "મિની ગેમ {fileName}",
  "officeFile.failedToParse": "ઇનલાઇન પ્રીવ્યૂ પાર્સ કરવામાં નિષ્ફળ.",
  "officeFile.localPreviewUnavailable": "સ્થાનિક પ્રીવ્યૂ ઉપલબ્ધ નથી. સ્થાનિક રીતે ખોલવા ફરી જોડો.",
  "officeFile.openFile": "ફાઇલ ખોલો",
  "officeFile.openInGoogleWorkspace": "Google Workspace માં ખોલો",
  "officeFile.parsingInlinePreview": "ઇનલાઇન પ્રીવ્યૂ પાર્સ...",
  "officeFile.parsingPreview": "પ્રીવ્યૂ પાર્સ...",
  "officeFile.previewUnavailable": "આ ફાઇલ માટે પ્રીવ્યૂ ઉપલબ્ધ નથી.",
  "officeFile.rawExtractedText": "કાઢેલ કાચો ટેક્સ્ટ",
  "sessionControls.customizeColors": "રંગ કસ્ટમાઇઝ કરો",
  "streaming.connectingTo": "{model} સાથે જોડાઈ રહ્યા છીએ (પ્રયાસ {attempt}/{total})...",
  "streaming.failedToPrepareAttachment": "મોકલવા માટે તાજેતરની સંલગ્ન ફાઇલ \"{name}\" તૈયાર કરવામાં નિષ્ફળ. ફરી પ્રયાસ કરો અથવા ફાઇલ ફરી જોડો.",
  "streaming.failedToPrepareCurrent": "Gemini માટે જોડેલ મીડિયા \"{name}\" તૈયાર કરવામાં નિષ્ફળ. ફરી પ્રયાસ કરો અથવા ફાઇલ ફરી જોડો.",
  "streaming.highDemand": "વધુ માગ શોધી. Google સર્વર પર વિનંતી કૂ માં છે.",
  "streaming.noOutputAfter": "{seconds} સેકન્ડ પછી મૉડેલ આઉટપૂટ નથી. Google સર્વર પર વિનંતી કૂ માં હોઈ શકે.",
  "streaming.phaseConnecting": "જોડાઈ રહ્યા",
  "streaming.phaseFinalResponse": "અંતિમ પ્રતિભાવ",
  "streaming.phaseFinalizing": "અંતિમ સ્વરૂપ",
  "streaming.phaseHighDemand": "વધુ માગ",
  "streaming.phasePreparingRequest": "વિનંતી તૈયાર",
  "streaming.phaseProcessing": "પ્રક્રિયા",
  "streaming.phaseRetrying": "ફરી પ્રયાસ",
  "streaming.phaseSwitchingModel": "મૉડેલ બદલ્યું",
  "streaming.phaseThinking": "વિચારી રહ્યા",
  "streaming.preparingRequestContext": "વિનંતી સંદર્ભ તૈયાર...",
  "streaming.retryingIn": "{seconds} સેકન્ડ માં ફરી પ્રયાસ...",
  "streaming.switchingFallback": "ફૉલ-બૅક મૉડેલ {model} પર જઈ રહ્યા.",
  "streaming.waitingForOutput": "મૉડેલ આઉટપૂટ ની રાહ... {seconds} સેકન્ડ વીત્યા.",
  "textFile.rawText": "કાચો ટેક્સ્ટ",
  "textFile.unableToDecode": "ટેક્સ્ટ સંલગ્ન ફાઇલ ડિકોડ કરી શકાઈ નહિ.",
  "themeCustomizer.cancel": "રદ",
  "themeCustomizer.confirm": "પુષ્ટિ",
  "themeCustomizer.deletePreset": "સાચવેલ પ્રીસેટ ભૂંસો",
  "themeCustomizer.exportAs": "આ રૂપે નિકાસ",
  "themeCustomizer.exportToFile": "ફાઇલ માં નિકાસ",
  "themeCustomizer.importFromFile": "ફાઇલ માંથી આયાત",
  "themeCustomizer.instruction": "રંગ વર્તુળ ટૅપ કરો, પછી પિકરમાં ખેંચો. ફેરફાર તરત લાગુ.",
  "themeCustomizer.namePlaceholder": "થીમ નામ...",
  "themeCustomizer.quickThemes": "ઝડપી થીમ",
  "themeCustomizer.resetAll": "બધું રીસેટ",
  "themeCustomizer.saveAs": "આ રૂપે સાચવો",
  "themeCustomizer.saveAsPreset": "પ્રીસેટ તરીકે સાચવો",
  "themeCustomizer.storeDescription": "વધુ થીમ બ્રાઉઝ અને ખરીદો",
  "themeCustomizer.storeTitle": "થીમ સ્ટોર",
  "themeCustomizer.title": "રંગ પેઇન્ટ",
  "themeStore.buy": "ખરીદો",
  "themeStore.close": "બંધ",
  "themeStore.footerNote": "ખરીદી Google Play દ્વારા સંચાલિત છે અને તમારા Google ખાતા સાથે જોડાયેલ છે. ફરી ઇન્સ્ટૉલ પછી જૂની ખરીદી પુનઃ મેળવવા રિસ્ટોર બટન (↩) દબાવો.",
  "themeStore.loading": "થીમ લૉડ...",
  "themeStore.notAvailable": "થીમ ખરીદી ફક્ત Google Play દ્વારા Android પર ઉપલબ્ધ.",
  "themeStore.owned": "ખરીદેલ",
  "themeStore.purchaseFailed": "ખરીદી નિષ્ફળ. કૃપા કરી કનેક્શન તપાસો અને ફરી પ્રયાસ કરો.",
  "themeStore.restorePurchases": "ખરીદી પુનઃ-સ્થાપો",
  "themeStore.title": "થીમ સ્ટોર",
};