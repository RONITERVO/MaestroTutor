...
export const guTranslations: Record<string, string> = {
  ...
  "apiKeyGate.testerFormTitle": "એપનું પરીક્ષણ કરો",
  "apiKeyGate.testAppLink": " સબમિટ કર્યું છે અને ઈમેલ કન્ફર્મેશન મેળવ્યું છે? એપ્લિકેશન અહીં મેળવો: https://play.google.com/store/apps/details?id=com.ronitervo.maestrotutor",
  "apiKeyGate.testerFormDescription": "અમારા એન્ડ્રોઇડ બીટાનું આમંત્રણ મેળવવા માટે તમે Google Play Store માટે જે ઈમેલ વાપરો છો તે દાખલ કરો!",
  "apiKeyGate.testerFormSubmit": "અર્લી એક્સેસ મેળવો",
  "apiKeyGate.testerFormSubmitting": "મોકલી રહ્યું છે...",
  "apiKeyGate.testerFormSuccessTitle": "આભાર!",
  "apiKeyGate.testerFormSuccessDesc": "માણસો તમારા ઇમેઇલની પુષ્ટિ કરી રહ્યા છે. આમાં સમય લાગશે. આ લિંક {TheUserEmail} માટે તરત જ કામ કરશે નહીં.",
  "apiKeyGate.testerFormNextSteps": "જ્યારે પુષ્ટિ થઈ જાય (1 દિવસ સુધી) ત્યારે અમે તમને આ લિંક ઈમેલ કરીશું (તમે અત્યારે આ પૃષ્ઠ છોડી શકો છો): ",
  "apiKeyGate.testerFormError": "કંઈક ખોટું થયું. કૃપા કરીને ફરીથી પ્રયાસ કરો.",
  "apiKeyGate.testerFormMustBeGmail": "કૃપા કરીને Google Play માટે @gmail.com સરનામાનો ઉપયોગ કરો.",
